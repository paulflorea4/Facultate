package org.example.lab4.repository.file;
...
import org.example.lab4.repository.RepositoryException;
import org.example.lab4.repository.mock.ComputerRepairedFormInMemoryRepository;
...
public class ComputerRepairedFormFileRepository extends ComputerRepairedFormInMemoryRepository {
    ...
    private void readFromFile(){
        System.out.println("Looking for file: " + new File(filename).getAbsolutePath());
