...
public class JocClientRpcWorker implements Runnable,IJocObserver {
    ...
    private Response handleRequest(Request request) {
        switch (request.getType()) {
            ...
            case ALEGE:{
                Configuratie configuratie = (Configuratie) request.getData();
                try {
    ...
    public void jocPornit(List<Configuratie> configuratii, String mesaj) throws Exception {
        ...
        Object[] data = new Object[]{configuratii, mesaj};
    ...
    public void variantaAleasa(Configuratie configuratie) throws Exception {
        logger.info("Notificare jucator -> VARIANTA_ALEASA: {}", configuratie);
        sendResponse(new Response(ResponseType.ALES, configuratie));
    }
