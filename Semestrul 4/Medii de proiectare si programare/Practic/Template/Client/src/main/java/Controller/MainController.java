...
public class MainController implements IJocObserver {
    ...
    public void initData(IJocServices service, Jucator jucator,
        ...
        labelInfo2.setText("Stare: Se asteapta alti jucatori...");
    ...
    public void jocPornit(Cuvant cuvant, String mesaj) throws Exception {
        Platform.runLater(() -> {
            labelInfo1.setText("Punctaj: 0");
            labelInfo2.setText("Stare: "+ mesaj);
    ...
    @Override
    public void variantaAleasa(Cuvant cuvantAles) throws Exception {
        Platform.runLater(() -> {
            if (gameBoard != null) {
                this.cuvant = cuvantAles;
                gameBoard.setText("_ ".repeat(cuvantAles.getValoare().length()));
                setStatusMessage("Indiciu: " + cuvantAles.getIndiciu());
            }
            if (btnAlegeVarianta != null) btnAlegeVarianta.setDisable(true);
        });
    }
