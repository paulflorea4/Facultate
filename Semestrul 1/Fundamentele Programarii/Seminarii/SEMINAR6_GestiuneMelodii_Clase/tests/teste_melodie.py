...
def test_melodie():
    melodie1 = Melodie('T1', 'A1', 'folk', 3.40)
...
def test_validare():
    ...
    melodie1 = Melodie('T', 'A1', 'folk', 3.40)
    ...
    melodie2 = Melodie('Titlu', '', 'folk', 3.40)
    try:
    ...
    melodie3 = Melodie('Titlu', 'Artist', 'abc', 3.40)
    try:
    ...
    melodie4 = Melodie('Titlu', 'Artist', 'pop', 20.40)
    try:
    ...
    melodie5 = Melodie('Titlu', 'Artist', 'pop', 3.90)
    try:
    ...
    melodie4 = Melodie('T', 'Artist', 'abc', 20.77)
    try:
        validator.validate(melodie4)
        assert False
    except ValueError:
