...
def test_add_evaluare():
    ...
    try:
        ...
        assert False
    except RatingAlreadyExistsException:
        assert True
...
def test_most_listened_to():
    ...
    dto_list = assignment_service.most_listened_to()
    assert (dto_list[0].nr_ascultari == 4)
    assert (dto_list[0].titlu=="Highway Star")
